...
//        // Bottom Oval
        let pathBottom = UIBezierPath(ovalIn: CGRect(origin: CGPoint(x:(X - (arcRadius/2)), y:(Y - (arcRadius/2))), size: CGSize(width: arcRadius, height: arcRadius))).cgPath
...
//
//        // Middle Cap
        let pathMiddle = UIBezierPath(ovalIn: CGRect(origin: CGPoint(x:(X - (capRadius/2)) - (arcRadius/2), y:(Y - (capRadius/2))), size: CGSize(width:capRadius, height: capRadius))).cgPath
        ...
        // Top Oval
        let pathTop = UIBezierPath(ovalIn: CGRect(origin: CGPoint(x:(X - (arcRadius/2)), y:(Y - (arcRadius/2))),size: CGSize(width: arcRadius, height: arcRadius))).cgPath
